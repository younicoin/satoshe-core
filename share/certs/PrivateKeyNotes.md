...
unlocked to sign the SATOSHE-Qt.app bundle.
...
allowing somebody to distribute a SATOSHE-Qt.app or satoshe-qt-setup.exe with a valid
...
that the satoshe-qt.exe file inside the installer had not been tampered with.
