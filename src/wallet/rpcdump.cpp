...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"satosheaddress\"\n"
            "\nReveals the private key corresponding to 'satosheaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"satosheaddress\"   (string, required) The satoshe address for the private key\n"
            "\nResult:\n"
