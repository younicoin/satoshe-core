...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The SATOSHE developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "SATOSHE"
...
#define PACKAGE_BUGREPORT "https://github.com/SatosheNetwork"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SATOSHE"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SATOSHE 13.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "satoshe"
