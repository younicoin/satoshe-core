...
#if defined(NDEBUG)
# error "SATOSHE cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "SATOSHE Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // SATOSHE also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // SATOSHE also requires low S in sigs
