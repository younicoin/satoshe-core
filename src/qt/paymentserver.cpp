...
const QString BITCOIN_IPC_PREFIX("satoshe:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/satoshe-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/satoshe-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/satoshe-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click satoshe: links
...
//
// OSX-specific way of handling satoshe: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in satoshe: URIs
