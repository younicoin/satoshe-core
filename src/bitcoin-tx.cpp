...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s satoshe-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  satoshe-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded satoshe transaction") + "\n" +
              "  satoshe-tx [options] -create [commands]   " + _("Create hex-encoded satoshe transaction") + "\n" +
              "\n";
